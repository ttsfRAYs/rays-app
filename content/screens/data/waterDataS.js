...
export default class WaterDataScreen extends React.Component {
    constructor() {
        super();
    ...
    render() {
        return (
            <View style={styles.container}>
              ...
              <Text style={[styles.screenTitle, {marginBottom: 0}]}>Water Level</Text>
              ...
              <Text style={[styles.labelText, {marginTop: 0, fontSize: 30, marginBottom: 30}]}>{this.state.data[this.state.data.length - 1] == 1 ? "HIGH" : "LOW"}</Text>
              <View style={styles.barGraph}>
                  {this.state.data.map((value, index, array) => (
                      <View style={[styles.barGraphBar, {height: parseFloat(value) * 100, alignSelf: "baseline", display: "flex", flexDirection: "column-reverse", backgroundColor: parseFloat(value) < 20 ? "red" : "black"}]}>
